...
$conn = new mysqli($servername, $username, $password,$dbname);
    ...
    die("Connection failed: " . $conn->connect_error);
          ...
          $sql="INSERT INTO mydoubt (email,sub,ques) VALUES ('$email','$subject','$content')";
          $conn->query($sql);   
            } 
    }
?>
...
<html lang="en">
  ...
  <button type="submit" id="submit" class="btn btn-primary">Submit</button>&emsp;&emsp;
        <a href="newwelcome.php"><input type="button" value="Close" id="close" class="btn btn-primary"></a>
</form>
